...
+
--
https://docs.netapp.com/us-en/cloud-manager-replication/task-replicating-data.html["Documentación de replicación"^]

--
Realice backups de los datos:: Realice backups de datos de su sistema ONTAP en las instalaciones a un almacenamiento de objetos de bajo coste en el cloud con Cloud Backup.
+
--
https://docs.netapp.com/us-en/cloud-manager-backup-restore/concept-backup-to-cloud.html["Documentación de Cloud Backup"^]
...
+
--
https://docs.netapp.com/us-en/cloud-manager-data-sense/concept-cloud-compliance.html["Documentación de Cloud Data Sense"^]

--
Organice los datos en niveles en el cloud:: Amplíe su centro de datos al cloud organizando en niveles los datos inactivos de los clústeres de ONTAP en el almacenamiento de objetos mediante Cloud Tiering.
+
--
https://docs.netapp.com/us-en/cloud-manager-tiering/concept-cloud-tiering.html["Documentación de Cloud Tiering"^]
